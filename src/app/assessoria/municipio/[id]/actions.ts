...
export async function addRecord(table: string, municipioId: string, data: any) {
  try {
...
export async function updateRecord(table: string, id: string, municipioId: string, data: any) {
  try {
    const supabase = await getSupabaseAuth();
